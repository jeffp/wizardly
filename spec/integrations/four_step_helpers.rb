module FourStepHelpers
  ...
  def step_to_third_page
    step_to_second_page
    fill_in_second_page
    click_button next_button
  end
  def fill_in_third_page
  ...
  def fill_in_finish_page
    ...
    fill_in(/user_password/, :with=>field_password)
    fill_in(/user_password_confirmation/, :with=>field_password_confirmation)
  end
